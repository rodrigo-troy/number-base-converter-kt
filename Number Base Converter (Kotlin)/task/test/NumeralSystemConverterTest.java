...
public class NumeralSystemConverterTest extends StageTest<String> {
    ...
    CheckResult test2() {
        ...
        actualResult = Converter_HsTest.convertDecimalToBaseX(randomDecimal,
                                                              2);
        ...
        for (int sourceBase = 2; sourceBase <= 18; sourceBase += 3) {
            ...
            for (int targetBase = 2; targetBase <= 36; targetBase += 3) {
                ...
                actualResult = Converter_HsTest
                        .convertSourceToTargetBase(randomSourceNumber,
                                                   sourceBase,
                                                   targetBase);
...
class Converter_HsTest {
    static String convertDecimalToBaseX(String num,
                                        int targetBase) {
        return new BigInteger(String.valueOf(num)).toString(targetBase);
    }

    static String convertBaseXToDecimal(String number,
                                        int sourceBase) {
    ...
    static String convertSourceToTargetBase(String number,
        ...
        String decimal = convertBaseXToDecimal(number,
                                               sourceBase);

        //Step 2 - convert decimal to target base
        return convertDecimalToBaseX(decimal,
                                     targetBase);
    }
}
