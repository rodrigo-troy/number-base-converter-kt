...
public class NumeralSystemConverterTest extends StageTest<String> {
    ...
    CheckResult test2() {
        ...
        actualResult = convertDecimalToBaseX(randomNumber,
                                             2);
    ...
    CheckResult test5() {
        ...
        actualResult = convertBaseXToDecimal(randomSourceNumber,
                                             2);
    ...
    //Helper methods
    String convertDecimalToBaseX(int num,
                                 int targetBase) {
        return Integer.toString(num,
                                targetBase);
    }

    String convertBaseXToDecimal(String number,
                                 int sourceBase) {
