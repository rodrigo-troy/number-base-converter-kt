...
public class NumeralSystemConverterTest extends StageTest<String> {
    ...
    CheckResult test2() {
        ...
        randomDecimal = hstest.Generator_HsTest.getRandomSourceNumber(10,
                                                                      false);
        actualResult = hstest.Converter_HsTest.decimalToBaseX(randomDecimal,
                                                              2);
    ...
    CheckResult test3() {
        ...
        main.start();
        main.execute("10 2");
        main.execute(hstest.Generator_HsTest.getRandomSourceNumber(10,
                                                                   false));
        ...
        main.execute("10 8");
        output = main.execute(hstest.Generator_HsTest.getRandomSourceNumber(10,
                                                                            false)).toLowerCase();
    ...
    CheckResult test4() {
        ...
        for (int sourceBase = 2; sourceBase <= 18; sourceBase += 3) {
            ...
            for (int targetBase = 2; targetBase <= 36; targetBase += 3) {
                ...
                randomBigInteger = hstest.Generator_HsTest.getRandomBigInteger(sourceBase,
                                                                               false);
    ...
    CheckResult test6() {
        ...
        for (int sourceBase = 2; sourceBase <= 18; sourceBase += 3) {
            for (int targetBase = 2; targetBase <= 36; targetBase += 3) {
                ...
                randomFraction = hstest.Generator_HsTest.getRandomSourceNumber(sourceBase,
                                                                               true);
                ...
                if (!actualResult.contains(userResult.substring(0,
                    ...
                    return CheckResult.wrong("The conversion result of your program is wrong.\n" +
                                             ...
                                             "Correct answer: " + actualResult.substring(0,
                                                                                         actualResult.indexOf(".") + 6));
                }
    ...
    CheckResult test8() {
        ...
        for (int sourceBase = 2; sourceBase <= 18; sourceBase += 3) {
            ...
            for (int targetBase = 2; targetBase <= 36; targetBase += 3) {
                ...
                randomFraction = hstest.Generator_HsTest.getRandomBigInteger(sourceBase,
                                                                             true);
                actualResult = hstest.Converter_HsTest.convertSourceToTargetBase(randomFraction,
                                                                                 sourceBase,
                                                                                 targetBase,
                ...
                boolean correct = hstest.CheckConversion_HsTest.check(userResult,
                                                                      actualResult);
                if (!correct) {
                    return CheckResult.wrong("The conversion result of your program is wrong\n" +
                                             "Your answer:\n" + userResult + "\n" +
...
class Generator_HsTest {
    ...
    static String getRandomSourceNumber(int sourceBase,
        ...
        if (fraction) {
            ...
            return hstest.Converter_HsTest.fractionToBaseX(dec,
                                                           sourceBase);
        } else {
    ...
    static String getRandomBigInteger(int sourceBase,
        ...
        if (fraction) {
            ...
            actualRandomDec = actualRandomDec.setScale(10,
                                                       RoundingMode.FLOOR);
            ...
            do {
                randomNumber = new BigInteger(upperLimit.bitLength(),
                                              new Random());
...
class Converter_HsTest {
    ...
    static String decimalToBaseX(String num,
                                 int targetBase) {
    ...
    static String baseXToDecimal(String number,
                                 int sourceBase) {
    ...
    static String convertSourceToTargetBase(String number,
                                            int sourceBase,
                                            int targetBase,
                                            boolean fraction) {
        ...
        if (fraction) {
            ...
            String decimal = baseXToDecimal(number,
                                            sourceBase);

            //Step 2 - convert decimal to target base
            return decimalToBaseX(decimal,
                                  targetBase);
        }
    ...
    static String baseXToDecimalFraction(String number,
                                         int len,
                                         int sourceBase) {
...
class CheckConversion_HsTest {
    ...
    static boolean check(String userResult,
                         String actualResult) {
